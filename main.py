...
def display_maze(recent_coord=None):
    ...
    for row in range(maze_width):
        for col in range(maze_height):
            ...
            if cell.walls[0]:
                pygame.draw.line(screen, (0, 0, 0), (cur_cell_x, cur_cell_y), (cur_cell_x + cell_width, cur_cell_y), line_width)
            if cell.walls[1]:
                pygame.draw.line(screen, (0, 0, 0), (cur_cell_x + cell_width, cur_cell_y), (cur_cell_x + cell_width, cur_cell_y + cell_height), line_width)
            if cell.walls[2]:
                pygame.draw.line(screen, (0, 0, 0), (cur_cell_x, cur_cell_y + cell_height), (cur_cell_x + cell_width, cur_cell_y + cell_height), line_width)
            if cell.walls[3]:
                pygame.draw.line(screen, (0, 0, 0), (cur_cell_x, cur_cell_y), (cur_cell_x, cur_cell_y + cell_height), line_width)
